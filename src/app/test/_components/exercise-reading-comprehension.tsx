...
export default function ReadingComprehensionCard({
  exercise,
  selectedOptionIndex,
  isAnswered,
  onSelectOption,
  ...
  return (
    <article
      ...
      aria-label={`Lectura de ${exercise.grammarTopic}`}
    >
      ...
      <div className="mb-6 rounded-xl border border-primary/6 bg-gradient-to-br from-surface-card to-surface-alt/18 p-4 sm:p-5">
        <p className="text-[0.6875rem] font-semibold uppercase tracking-[0.08em] text-primary/28">
          Lee el texto
        </p>
        <p className="mt-2 font-serif text-sm leading-[1.7] text-primary/78 sm:text-base sm:leading-relaxed">
          {exercise.passage}
        </p>
      </div>
      ...
      <blockquote className="relative mb-5 border-l-[3px] border-celeste py-1 pl-5 sm:pl-6">
