...
export default function QuestionAnswerCard({
  ...
  return (
    ...
    >
      ...
      <p className="mb-4 text-sm font-medium text-navy/50 sm:text-base">
      ...
      <div
        className={`mb-6 rounded-xl border-2 p-4 sm:p-5 ${
          isFindQuestion
            ? "border-navy/10 bg-cream-card"
            : "border-navy/10 bg-cream-card"
        }`}
      >
        <p className="mb-1 text-xs font-semibold uppercase tracking-wider text-navy/35">
