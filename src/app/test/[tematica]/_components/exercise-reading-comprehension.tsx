...
export default function ReadingComprehensionCard({
  ...
  return (
    ...
    >
      ...
      <div className="mb-6 rounded-xl border border-navy/8 bg-cream-card p-4 sm:p-5">
        <p className="text-xs font-semibold uppercase tracking-wider text-navy/35">
          Lee el texto
        </p>
        <p className="mt-2 font-serif text-sm leading-relaxed text-navy/80 sm:text-base">
          {exercise.passage}
        </p>
      </div>

      <p className="mb-2 text-sm font-medium text-navy/50 sm:text-base">
